...
export function WhatsAppButton() {
  ...
  // Hide on /devis page to avoid CTA conflict
      ...
      {visible && (
        ...
        >
          ...
          <a
            ...
            className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/30 transition-transform hover:scale-110"
          >
            <svg
              viewBox="0 0 24 24"
              fill="white"
