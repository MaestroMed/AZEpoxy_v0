      ...
      {visible && (
        ...
        >
          ...
          <a
            ...
            data-magnetic
            className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-brand-night ring-1 ring-white/10 shadow-xl shadow-black/30 transition-all duration-300 hover:scale-110 hover:ring-brand-success/40 hover:shadow-2xl hover:shadow-black/40"
          >
            {/* Pulse ring (ambient, much more subtle) */}
            <span
              aria-hidden
              className="pointer-events-none absolute inset-0 rounded-full border border-brand-success/25 motion-safe:animate-ping"
              style={{ animationDuration: "2.8s" }}
            />
            {/* Tiny WhatsApp green accent dot — brand signal without the fluo */}
            <span
              aria-hidden
              className="pointer-events-none absolute right-0 top-0 h-2.5 w-2.5 rounded-full bg-brand-success ring-2 ring-brand-night"
            />
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
              className="relative h-7 w-7 text-white transition-all duration-300 group-hover:rotate-[-8deg] group-hover:text-brand-success"
              aria-hidden="true"
            >
