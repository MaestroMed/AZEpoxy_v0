...
const PROCESS_STEPS = [
  ...
  },
  {
    ...
    title: "Thermolaquage",
    description:
      "Application de la poudre époxy par pistolet électrostatique, puis cuisson en four de cuisson, durée variable selon la pièce. Le film atteint 60-80 µm d'épaisseur.",
  },
  {
    num: "04",
