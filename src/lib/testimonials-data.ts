...
export const TESTIMONIALS_FALLBACK: Testimonial[] = [
  ...
  },
  {
    ...
    quote:
      "J'ai spécifié les effets Corten pour les bardages d'un projet de réhabilitation. L'effet corten est saisissant de réalisme, sans les contraintes d'entretien de l'acier autopatinable. AZ Époxy a parfaitement compris le cahier des charges.",
